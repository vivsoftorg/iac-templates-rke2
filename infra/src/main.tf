data "aws_ami" "rhel8" {
  most_recent = true
  owners      = ["309956199498"] # owner is specific to aws commercial cloud
...
module "rke2" {
  source                                        = "git::https://github.com/rancherfederal/rke2-aws-tf.git?ref=v2.4.0"
...
module "rke2_agents" {
  source                      = "git::https://github.com/rancherfederal/rke2-aws-tf.git//modules/agent-nodepool?ref=v2.4.0"
